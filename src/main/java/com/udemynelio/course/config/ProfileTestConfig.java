...
public class ProfileTestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order orderOne = new Order(null, Instant.parse("2024-06-05T19:53:07Z"), userOne);
        Order orderTwo = new Order(null, Instant.parse("2024-05-20T03:42:10Z"), userTwo);
        Order orderThree = new Order(null, Instant.parse("2024-04-21T15:21:22Z"), userOne);
